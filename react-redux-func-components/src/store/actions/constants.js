export const actionRequestType = {
    ...
    ADD_TOAST_REQUEST: "ADD_TOAST_REQUEST",
    DISMISS_TOAST_REQUEST: "DISMISS_TOAST_REQUEST",
    SET_QUERY_REQUEST: "SET_QUERY_REQUEST",
    SET_CURRENT_PAGE_REQUEST: "SET_CURRENT_PAGE_REQUEST",
    SET_CURRENT_FILTER_REQUEST: "SET_CURRENT_FILTER_REQUEST",
};
...
export const actionSuccessType = {
    ...
    ADD_TOAST_SUCCESS: "ADD_TOAST_SUCCESS",
    DISMISS_TOAST_SUCCESS: "DISMISS_TOAST_SUCCESS",
    CLEAR_TODOS_SUCCESS: "CLEAR_TODOS_SUCCESS",
    SET_QUERY_SUCCESS: "SET_QUERY_SUCCESS",
    SET_CURRENT_PAGE_SUCCESS: "SET_CURRENT_PAGE_SUCCESS",
    SET_CURRENT_FILTER_SUCCESS: "SET_CURRENT_FILTER_SUCCESS",
};
...
export const actionFailureType = {
    ...
    ADD_TOAST_FAILURE: "ADD_TOAST_FAILURE",
    DISMISS_TOAST_FAILURE: "DISMISS_TOAST_FAILURE",
    GET_TODOS_FAILURE: "GET_TODOS_FAILURE",
    SET_QUERY_FAILURE: "SET_QUERY_FAILURE",
    SET_CURRENT_PAGE_FAILURE: "SET_CURRENT_PAGE_FAILURE",
    SET_CURRENT_FILTER_FAILURE: "SET_CURRENT_FILTER_FAILURE",
};
